...
namespace crystalCLAIMSAPI.Migrations
{
    ...
    [Migration("20180928174730_StandardService")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("crystalCLAIMSAPI.Models.HealthcareService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CCT_HealthcareServices");

                    b.HasDiscriminator<string>("Discriminator").HasValue("HealthcareService");
                });
            ...
            modelBuilder.Entity("crystalCLAIMSAPI.Models.StandardDiagnosis", b =>
                {
                    b.HasBaseType("crystalCLAIMSAPI.Models.HealthcareService");

                    b.Property<string>("Comment");

                    b.ToTable("CCT_StandardDiagnosis");

                    b.HasDiscriminator().HasValue("StandardDiagnosis");
                });
            ...
            modelBuilder.Entity("crystalCLAIMSAPI.Models.StandardDrug", b =>
                {
                    ...
                    b.Property<string>("Comment")
                        .HasColumnName("StandardDrug_Comment");

                    b.ToTable("CCT_StandardDrugs");

                    b.HasDiscriminator().HasValue("StandardDrug");
                });
            ...
            modelBuilder.Entity("crystalCLAIMSAPI.Models.StandardServiceProvided", b =>
                {
                    ...
                    b.Property<string>("Comment")
                        .HasColumnName("StandardServiceProvided_Comment");

                    b.ToTable("CCT_StandardServiceProvided");

                    b.HasDiscriminator().HasValue("StandardServiceProvided");
                });
            ...
            modelBuilder.Entity("crystalCLAIMSAPI.Models.HCPDiagnosis", b =>
                {
                    b.HasOne("crystalCLAIMSAPI.Models.HealthcareProvider")
                        .WithMany("Diagnosis")
                        .HasForeignKey("HealthcareProviderId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
